...
<body onload="displayByUser()">
    <div class="title-dash-container">
        ...
        <div class="nav nav-container">
            ...
            <div id="searchbar">
                <input id="search" type="text" placeholder="Search" onkeyup="searchTable()">
            </div>
        </div>
    </div>
    ...
    <div class="table-container">
        <div id="instructions">
            ...
            <p>Here you will be able to add and view all reimbursements submitted to the system.</p>
            <p>Finance Managers will view and approve or deny your reimbursements as they see fit.</p>
        </div>
